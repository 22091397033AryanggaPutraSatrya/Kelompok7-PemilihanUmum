...
<head>
    ...
    <title>Surat Suara DPRD Kabupaten/Kota</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-success d-flex align-items-center justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-md-10 d-flex align-items-center">
                    <div class="card-body text-center text-white">
                        ...
                        <h1 class="card-title mb-0">Dewan Perwakilan Rakyat Daerah Kabupaten/Kota</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        @foreach($dprdkab_submissions as $partai => $submissions)
            ...
            <table class="table table-hover mb-5">
                ...
                <tbody>
                    @foreach($submissions as $dprdkab)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td>{{ $dprdkab->nama }}</td>
                            <td class="text-end">
                                <a href="{{ route('detaildprdkab', $dprdkab->id) }}" class="btn btn-success btn-sm">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
