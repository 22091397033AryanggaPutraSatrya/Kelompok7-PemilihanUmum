...
<head>
    ...
    <title>DPRD KABUPATEN | Lihat Portofolio</title>
...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <main class="container" style="margin-top: 50px;">
        <h1 style="margin-bottom: 20px">Data Caleg DPRD Kabupaten</h1>
        ...
        <div class="row">
          <div class="col-md-12" style="margin-top: 20px;">
              ...
              {{-- <a href="{{ route('portofolio/dprdprov/edit', $form_dprdkab->id) }}" class="btn btn-primary">Edit</a> 
