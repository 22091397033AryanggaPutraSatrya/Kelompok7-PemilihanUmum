...
<body>
    ...
    <main class="container mt-5">
        ...
        <form action="{{ route('update', $form_dpr->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama" class="form-control" value="{{ $form_dpr->nama }}" required>
            </div>
            <div class="mb-3">
                <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                <input type="text" name="jenis_kelamin" class="form-control" value="{{ $form_dpr->jenis_kelamin }}" required>
            </div>
            <div class="mb-3">
                <label for="tempat_tanggal_lahir" class="form-label">Tempat Tanggal Lahir</label>
                <input type="text" name="tempat_tanggal_lahir" class="form-control" value="{{ $form_dpr->tempat_tanggal_lahir }}" required>
            </div>
            <div class="mb-3">
                <label for="partai" class="form-label">Partai</label>
                <input type="text" name="partai" class="form-control" value="{{ $form_dpr->partai }}" required>
            </div>
            <div class="mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                <input type="text" name="alamat" class="form-control" value="{{ $form_dpr->alamat }}" required>
            </div>
            <div class="mb-3">
                <label for="kota" class="form-label">Kota</label>
                <input type="text" name="kota" class="form-control" value="{{ $form_dpr->kota }}" required>
            </div>
            <div class="mb-3">
                <label for="provinsi" class="form-label">Provinsi</label>
                <input type="text" name="provinsi" class="form-control" value="{{ $form_dpr->provinsi }}" required>
            </div>
            <div class="mb-3">
                <label for="kode_pos" class="form-label">Kode Pos</label>
                <input type="text" name="kode_pos" class="form-control" value="{{ $form_dpr->kode_pos }}" required>
            </div>
            <div class="mb-3">
                <label for="visi_misi" class="form-label">Visi Misi</label>
                <textarea name="visi_misi" class="form-control" required>{{ $form_dpr->visi_misi }}</textarea>
            </div>
            <div class="mb-3">
                <label for="pendidikan" class="form-label">Pendidikan</label>
                <textarea name="pendidikan" class="form-control" required>{{ $form_dpr->pendidikan }}</textarea>
            </div>
            <div class="mb-3">
                <label for="pengalaman_kerja" class="form-label">Pengalaman Kerja</label>
                <textarea name="pengalaman_kerja" class="form-control" required>{{ $form_dpr->pengalaman_kerja }}</textarea>
            </div>
            <div class="mb-3">
                <label for="organisasi" class="form-label">Organisasi</label>
                <textarea name="organisasi" class="form-control" required>{{ $form_dpr->organisasi }}</textarea>
            </div>
            <div class="mb-3">
                <label for="prestasi" class="form-label">Prestasi</label>
                <textarea name="prestasi" class="form-control" required>{{ $form_dpr->prestasi }}</textarea>
            </div>
