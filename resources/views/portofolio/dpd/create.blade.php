...
<html lang="en" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>DPD | Pengisian Portofolio</title>
...
<main>
    ...
    <form class="row g-3" style="margin: 80px; margin-top: 30px;" action="{{ route('form_dpd.store') }}" method="POST">
        @csrf
        <h3 style="margin-bottom: 20px">Form Pengisisan Portofolio DPD</h3>
        <div class="col-md-6">
