...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <main class="container" style="margin-top: 50px;">
        <h1 style="margin-bottom: 20px">Data Caleg DPD</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-left: -130px">
              <div class="mb-3">
                ...
                <input class="form-control" type="text" value="{{ $form_dpd->nama }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Jenis Kelamin</label>
                <input class="form-control" type="text" value="{{ $form_dpd->jenis_kelamin }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Kewarganegaraan</label>
                <input class="form-control" type="text" value="{{ $form_dpd->kewarganegaraan }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Tempat Tanggal Lahir</label>
                <input class="form-control" type="text" value="{{ $form_dpd->tempat_tanggal_lahir }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Partai</label>
                <input class="form-control" type="text" value="{{ $form_dpd->partai }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Kota</label>
                <input class="form-control" type="text" value="{{ $form_dpd->kota }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Provinsi</label>
                <input class="form-control" type="text" value="{{ $form_dpd->provinsi }}" aria-label="Disabled input example" disabled readonly>
              </div>
              <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Kode Pos</label>
                <input class="form-control" type="text" value="{{ $form_dpd->kode_pos }}" aria-label="Disabled input example" disabled readonly>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12" style="margin-top: 20px;">
              ...
              <a href="{{ route('portofolio/dpd/edit', $form_dpd->id) }}" class="btn btn-primary">Edit</a> 
