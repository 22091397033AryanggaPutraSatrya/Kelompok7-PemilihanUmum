...
<html lang="en" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>Portofolio DPRD Kabupaten</title>
...
<main>
  ...
  <div class="container marketing" style="text-align: center">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPRD Kabupaten 1</h4>
        <p >Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdprdkab', 1) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPRD Kabupaten 2</h4>
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdprdkab', 2) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPRD Kabupaten 3</h4>
        <p>And lastly this, the third column of representative placeholder content.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdprdkab', 3) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
  ...
  <div class="container marketing" style="text-align: center">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPRD Kabupaten 4</h4>
        <p >Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdprdkab', 4) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPRD Kabupaten 5</h4>
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdprdkab', 5) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPRD Kabupaten 6</h4>
        <p>And lastly this, the third column of representative placeholder content.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdprdkab', 6) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
