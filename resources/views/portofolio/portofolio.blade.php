  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="#" style="margin-right: 20px;">Portofolio</a>
        </li>
         
        <li class="nav-item">
            <a class="nav-link" href="{{ route('show', 1) }}">Portofolio view</a>
        </li>
    </ul>
...
<main>
    ...
    <form class="row g-3" style="margin: 80px" action="{{ route('form_dpr.store') }}" method="POST">
        @csrf
        <div class="col-md-6">
