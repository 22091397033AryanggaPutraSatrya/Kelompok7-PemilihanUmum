...
<head>
    ...
    <title>DPR | Lihat Portofolio</title>
    ...
    <main class="container" style="margin-top: 50px;">
        ...
        <div class="row">
          <div class="col-md-12" style="margin-top: 20px;">
              ...
              {{-- <a href="{{ route('portofolio/dprdprov/edit', $form_dpr->id) }}" class="btn btn-primary">Edit</a> 
