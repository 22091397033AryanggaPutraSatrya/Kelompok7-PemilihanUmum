...
<main>
  ...
  <div class="container marketing" style="text-align: center">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPR 1</h4>
        <p >Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdpr', 1) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPR 2</h4>
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdpr', 2) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPR 3</h4>
        <p>And lastly this, the third column of representative placeholder content.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdpr', 3) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
  ...
  <div class="container marketing" style="text-align: center">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPR 4</h4>
        <p >Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdpr', 4) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPR 5</h4>
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdpr', 5) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="250" height="250" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOH2aZnIHWjMQj2lQUOWIL2f4Hljgab0ecZQ&usqp=CAU" alt="Placeholder">
        <h4 class="fw-normal" style="margin-top: 20px">Caleg DPR 6</h4>
        <p>And lastly this, the third column of representative placeholder content.</p>
        <p><a class="btn btn-danger" href="{{ route('portofolio/showdpr', 6) }}">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
